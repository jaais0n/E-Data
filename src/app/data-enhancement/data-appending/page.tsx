          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl font-bold mb-8 leading-tight" data-aos="fade-up">
                How Data Appending Service From E-Data Grid Boost <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">Your Business?</span>
              </h2>
              <div className="text-on-surface-variant text-body-lg space-y-6 leading-relaxed">
                <p>
                  E-Data Grid's data appending service is critical in keeping your database up-to-date and accurate. It is an effective process to add missing information like email addresses, phone numbers, and physical addresses to your existing customer data file.
                </p>
                <p>
