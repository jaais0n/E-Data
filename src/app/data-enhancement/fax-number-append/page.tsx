            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="pt-8 border-t border-outline-variant/30">
                ...
                <p className="text-on-surface-variant text-body-md leading-relaxed">
                  Match rates for this service can vary depending upon the quality of data within clients file. The best results occur when an initial file is verified and clean. However, the E-Data Grid appending business fax match rate typically is 60-80% for business records and 40-50% for B2C records.
                </p>
              </div>
            </div>
            <div className="lg:col-span-5 relative">
