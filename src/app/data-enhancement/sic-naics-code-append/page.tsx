      ...
      <main className="pb-24 pt-12">
        ...
        <section className="max-w-[1280px] mx-auto px-5 md:px-10">
          <div className="bg-surface-container-lowest p-8 md:p-12 border border-outline-variant/30 rounded-3xl shadow-lg" data-aos="fade-up">
            ...
            <div className="mt-16">
              <h3 className="font-display-lg text-2xl text-primary font-bold mb-4">Why E-Data's SIC / NAICS Code Append Service?</h3>
              <p className="text-on-surface-variant mb-6 font-bold">Our SIC & NAICS Append Services:</p>
              <p className="text-on-surface-variant mb-6">E-Data is a leading data-driven company, and we make certain to provide you with data which is fully verified and accurate. Having precise data makes your business more flexible.</p>
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      "Affordable pricing",
                      "E-Data provides data which is CCPA and GDPR Compliant",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              <h2 className="font-display-lg text-3xl md:text-5xl font-bold mb-8 leading-tight" data-aos="fade-up">
                How E-Data Help Your Business Grow With <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">SIC / NAICS Code Appending Services?</span>
              </h2>
