...
export default function EmailValidationPage() {
  const otherServices = popularServices.filter(s => s.href !== "/data-enhancement/email-validation").slice(0, 3);
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-4">
            ...
            <h1 data-aos="fade-up" className="font-display-lg text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-white max-w-4xl tracking-tight">
              B2B Email Validation & <br />
              <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f] italic">List Cleansing Service</span>
            </h1>
            <p className="font-body-lg text-lg text-white/70 max-w-xl leading-relaxed pt-2">
              Cleanse your lists by identifying and removing invalid or honeypot email addresses to ensure maximum deliverability.
            </p>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative bg-[#131b2e] p-10 border border-[#1a2642] rounded-3xl shadow-2xl flex flex-col justify-center items-center text-center min-h-[440px]">
              ...
              <h3 className="font-display-lg text-2xl mb-4 text-white">Email Validation Service</h3>
              <p className="text-sm text-white/70 mb-8 leading-relaxed max-w-sm">
                Ready to cleanse your database with verified contact data? Click below to reach out to our sales team today.
              </p>
      ...
      <main className="pb-24 pt-12">
        ...
        <section className="max-w-[1280px] mx-auto px-5 md:px-10 pb-16 pt-8">
          <div className="bg-surface-container-lowest p-8 md:p-12 border border-outline-variant/30 rounded-3xl shadow-lg" data-aos="fade-up">
            <h2 className="font-display-lg text-3xl md:text-5xl font-black mb-8" data-aos="fade-up">About Email Validation 
              Services</h2>
            <div className="space-y-6">
              <div className="space-y-4 pt-4">
              {[
                "Email validation is the process of verifying if an email address is deliverable and valid. We provide quick and accurate email validation.",
                "Improve your email marketing campaign performance by cleaning up your list and removing invalid email addresses.",
                "Our Email Validation Services lower bounce rates and improve email deliverability to ensure your message reaches your target audience.",
                "Save time and effort by letting us remove invalid, inactive, and disposable email addresses from your list."
              ].map((item, i) => (
        ...
        <section className="max-w-[1280px] mx-auto px-5 md:px-10 py-12 border-b border-outline-variant/30">
          <div className="text-center mb-16 space-y-4" data-aos="fade-up">
            ...
            <h2 className="font-display-lg text-3xl md:text-5xl font-black" data-aos="fade-up">
              How Do We <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">Validate Data?</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/30 rounded-3xl shadow-sm hover:border-primary hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="font-headline-md text-lg text-primary mb-3 font-bold">Upload & Match</h3>
              <p className="text-sm text-on-surface-variant leading-relaxed">We receive your database and securely match it with our verification systems.</p>
            </div>
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/30 rounded-3xl shadow-sm hover:border-primary hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 mx-auto bg-[#8dc63f]/10 text-[#7cb037] rounded-2xl flex items-center justify-center mb-6">
                <span className="material-symbols-outlined text-3xl">mark_email_read</span>
              </div>
              <h3 className="font-headline-md text-lg text-primary mb-3 font-bold">Syntax & Domain Check</h3>
              <p className="text-sm text-on-surface-variant leading-relaxed">We identify and remove formatting errors and check domain validity.</p>
            </div>
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/30 rounded-3xl shadow-sm hover:border-primary hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="font-headline-md text-lg text-primary mb-3 font-bold">Cleanse & Scrub</h3>
              <p className="text-sm text-on-surface-variant leading-relaxed">Invalid, inactive, and disposable email addresses are scrubbed.</p>
            </div>
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/30 rounded-3xl shadow-sm hover:border-primary hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="font-headline-md text-lg text-primary mb-3 font-bold">Deliver Verified List</h3>
              <p className="text-sm text-on-surface-variant leading-relaxed">A clean, verified, and highly deliverable contact list is returned.</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl font-bold mb-8 leading-tight" data-aos="fade-up">
                How Our Email Validation Service Improve <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">Your Business?</span>
              </h2>
              <div className="text-on-surface-variant text-body-lg space-y-6 leading-relaxed">
                <p>
                  Email validation service is a critical step in maintaining a clean and healthy email list. Having clean email data means fewer bounces and improved sender reputation, which leads to better inbox placement and significantly higher engagement rates for your marketing campaigns.
                </p>
                <p>
                  We provide a complete hygiene check that identifies duplicate records, formatting errors, and obsolete email data. By using our email validation service, you can rest assured that your outreach goes to real, engaged prospects, helping you maximize your ROI and run your campaigns confidently without the risk of being marked as spam.
                </p>
              </div>
            </div>
            <div className="lg:col-span-5 relative">
