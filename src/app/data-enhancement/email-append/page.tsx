...
export default function EmailAppendPage() {
  const otherServices = popularServices.filter(s => s.href !== "/data-enhancement/email-append").slice(0, 3);
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
          <div className="lg:col-span-7 space-y-4">
            ...
            <p className="font-body-lg text-lg text-white/70 max-w-xl leading-relaxed pt-2">
              Append missing, verified business email addresses to your existing customer lists and maximize your digital outreach.
            </p>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative bg-[#131b2e] p-10 border border-[#1a2642] rounded-3xl shadow-2xl flex flex-col justify-center items-center text-center min-h-[440px]">
              ...
              <h3 className="font-display-lg text-2xl mb-4 text-white">Email Append Services</h3>
              <p className="text-sm text-white/70 mb-8 leading-relaxed max-w-sm">
                Ready to enhance your database with verified email contacts? Click below to reach out to our sales team today.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl font-bold mb-8 leading-tight" data-aos="fade-up">
                Add Missed Data To <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">Your Database</span>
              </h2>
              <div className="text-on-surface-variant text-body-lg space-y-6 leading-relaxed">
                <p>
                  Adding missing data to your database is an essential process to maintain data hygiene and run successful marketing campaigns. The B2B Email appending service Providers are considered as one of the best ways to get fresh B2B data.
                </p>
                <p>
                  Our expert data scientist team continuously works to enhance the data quality and deliver highly responsive data sets for B2B marketers. Our dedicated data scientists use the latest data appended methods, process data to provide accurate and updated B2B email lists to ensure maximum deliverability.
                </p>
              </div>
            </div>
            <div className="lg:col-span-5 relative">
