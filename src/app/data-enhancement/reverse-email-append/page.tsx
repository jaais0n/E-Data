          ...
          <div className="bg-surface-container-lowest p-8 md:p-12 border border-outline-variant/30 rounded-3xl shadow-lg" data-aos="fade-up">
            ...
            <div className="space-y-6">
              ...
              {[
                ...
                "At E-Data, with a massive business directory, we help you reverse append the missing piece of information and build a custom list to reach your target customers."
              ].map((item, i) => (
