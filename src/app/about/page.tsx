        ...
        <section className="max-w-[1280px] mx-auto px-5 md:px-10 pb-10 md:pb-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="mt-12 lg:mt-0 lg:pl-10">
              ...
              <h2 className="font-display-lg text-4xl lg:text-5xl mb-6 font-bold text-on-surface">Why <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">E-Data</span> !</h2>
              <p className="text-on-surface-variant text-body-lg leading-relaxed mb-10">
                Since 2008 E-Data is one of the pioneer and believed data drive data driven marketing services that provides marketing solutions comprising of business list, technology user list, healthcare list and also appending services.
              </p>
