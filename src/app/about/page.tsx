          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="mt-12 lg:mt-0 lg:pl-10">
              ...
              <p className="text-on-surface-variant text-body-lg leading-relaxed mb-10">
                Since 2008 E-Data Grid is one of the pioneer and believed data drive data driven marketing services that provides marketing solutions comprising of business list, technology user list, healthcare list and also appending services.
              </p>
