        ...
        <section className="bg-background py-20 border-b border-outline-variant/30">
          <div className="max-w-[1000px] mx-auto px-5 md:px-10 text-center space-y-6">
            ...
            <div className="text-lg md:text-xl text-on-surface-variant leading-relaxed space-y-4">
              <p>E-Data Grid technology email lists will help marketers to connect with technology professionals, technology users, and decision makers from the IT industry. Reach out to top technology executives globally using our comprehensive and updated technology email list.</p>
        ...
        <section className="py-16 bg-background border-b border-outline-variant/30 text-center">
          <div className="max-w-[1000px] mx-auto px-5 md:px-10">
            <div className="space-y-6 text-on-surface-variant leading-relaxed text-center">
              ...
              <p>
                <strong>Customization:</strong> Segment lists based on specific technologies, company size, revenue, and geography. E-Data Grid helps you customize the technology users list based on your specific business requirements to launch targeted B2B marketing campaigns successfully.
              </p>
              <p>
