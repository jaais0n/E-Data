          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="text-on-surface-variant text-body-lg space-y-4 leading-relaxed">
                ...
                <p>With E-Data's targeted email list, you can seamlessly connect with your potential clients globally and expand your business reach. Our data is gathered from authentic sources and verified regularly to ensure maximum accuracy.</p>
              </div>
            </div>
