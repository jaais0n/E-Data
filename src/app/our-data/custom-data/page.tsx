      ...
      <main className="py-24">
        ...
        <section className="max-w-[1280px] mx-auto px-5 md:px-10 py-24 border-b border-outline-variant/30 text-center">
          <div className="max-w-4xl mx-auto space-y-8 bg-surface-container-low/40 p-12 rounded-3xl border border-outline-variant/20 relative overflow-hidden">
            ...
            <p className="text-body-lg text-on-surface-variant leading-relaxed">
              At E-Data, we specialize in building custom databases that match your precise target audience parameters, ensuring maximum outreach conversion rates and campaign performance.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl font-bold mb-8 leading-tight" data-aos="fade-up">
                How E-Data Help Your Business Grow With <span className="text-transparent bg-clip-text pr-1 bg-gradient-to-r from-blue-400 to-[#8dc63f]">Custom Email List?</span>
              </h2>
              <div className="text-on-surface-variant text-body-lg space-y-6 leading-relaxed">
                <p>
                  E-Data provides the foundational intelligence for high-performance enterprise outreach. We compile targeted marketing contact fields, verifying all records through a triple-layer validation process before delivery.
                </p>
                <p>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative z-10 diffusion-shadow overflow-hidden rounded-3xl">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Grow Business Custom" className="w-full h-auto object-cover grayscale-[0.2] hover:grayscale-0 transition-all duration-700" />
              </div>
