...
const faqs = [
  ...
  {
    q: "How reliable is E-Data data?",
    a: "80% of our business comes from returning customers, and they all promote us and give referrals. Both the product and the client are important to E-Data. If you’re expanding, we can offer reliable advice."
  },
  {
    q: "How does E-Data validate data?",
          ...
          <div className="max-w-[1280px] mx-auto px-5 md:px-10 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-body-lg text-white/70 max-w-xl mb-8 leading-relaxed">
                E-Data technology email lists will help marketers to connect with technology professionals, technology users, and decision makers from the IT industry. Reach out to top technology executives globally using our comprehensive and updated technology email list.
              </p>
            </div>
        ...
        <section className="bg-surface-container-lowest py-24 border-b border-outline-variant/30">
          <div className="max-w-[1280px] mx-auto px-5 md:px-10 text-center mb-10 md:mb-16">
            ...
            <h2 className="font-display-lg text-3xl md:text-5xl font-black mb-6" data-aos="fade-up">
              Key Technology Users List From <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-[#8dc63f] pr-1">E-Data</span>
            </h2>
